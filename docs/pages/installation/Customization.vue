  ...
  <div>
      ...
      <div class="media-content">
        ...
        <b-message type="is-info">
          <div class="content">
            ...
            <ol>
              <li>
                <code>$speed-slow: 150ms !default</code>
              </li>
              <li>
                <code>$speed-slower: 250ms !default</code>
              </li>
            </ol>
          </div>
        </b-message>
        <b-message type="is-warning">
          ...
          <code>node-sass</code> and
          <code>sass-loader</code> depending on your environment.
        </b-message>
        <p class="block">
          It can be done in your
          <b>App.vue</b> within the
          <code>&lt;style lang="scss"&gt;</code> tag, or in a separate
          <b>.scss</b> file.
        </p>
    ...
    <div class="media">
      ...
      <div class="media-content">
        ...
        <b-message type="is-warning">
          Please note that
          <code class="javascript">import 'buefy/dist/buefy.css'</code> from the
          <router-link to="/documentation/start">start section</router-link>has been omitted.
        </b-message>
    ...
    <div class="media">
      ...
      <div class="media-content">
        <h3 class="subtitle">Use our Theme builder page</h3>
        <p class="block">
          Check out our
          <router-link :to="{path:'/documentation/themebuilder'}">Theme builder page</router-link>
        </p>
      </div>
    </div>
  </div>
